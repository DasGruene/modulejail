...
```sh
curl -fsSL https://raw.githubusercontent.com/jnuyens/modulejail/v1.4.1/modulejail | sudo sh
```
...
>
> ```sh
> curl -fsSL https://raw.githubusercontent.com/jnuyens/modulejail/v1.4.1/modulejail | sudo sh -s -- -p desktop
> ```
>
...
```sh
curl -fsSL https://raw.githubusercontent.com/jnuyens/modulejail/v1.4.1/modulejail | sudo sh -s -- -o /etc/modprobe.d/site-blacklist.conf
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/jnuyens/modulejail/v1.4.1/modulejail -o /tmp/modulejail
less /tmp/modulejail
...
```sh
# Debian / Ubuntu:
curl -fsSLO https://github.com/jnuyens/modulejail/releases/download/v1.4.1/modulejail_1.4.1_all.deb
sudo dpkg -i modulejail_1.4.1_all.deb

# RHEL / Fedora / Rocky:
curl -fsSLO https://github.com/jnuyens/modulejail/releases/download/v1.4.1/modulejail-1.4.1-1.noarch.rpm
sudo rpm -i modulejail-1.4.1-1.noarch.rpm
```
...
> ```
>
> From then on, `git tag -a v1.4.1 -m "..."` auto-signs without the
...
- **`master`** tracks the latest stable release (currently `v1.4.1`).
