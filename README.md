...
```sh
curl -fsSL https://raw.githubusercontent.com/jnuyens/modulejail/v1.3.2/modulejail | sudo sh
```
...
>
> ```sh
> curl -fsSL https://raw.githubusercontent.com/jnuyens/modulejail/v1.3.2/modulejail | sudo sh -s -- -p desktop
> ```
>
...
```sh
curl -fsSL https://raw.githubusercontent.com/jnuyens/modulejail/v1.3.2/modulejail | sudo sh -s -- -o /etc/modprobe.d/site-blacklist.conf
```
...
```sh
curl -fsSL https://raw.githubusercontent.com/jnuyens/modulejail/v1.3.2/modulejail -o /tmp/modulejail
less /tmp/modulejail
...
```sh
# Debian / Ubuntu:
curl -fsSLO https://github.com/jnuyens/modulejail/releases/download/v1.3.2/modulejail_1.3.2_all.deb
sudo dpkg -i modulejail_1.3.2_all.deb

# RHEL / Fedora / Rocky:
curl -fsSLO https://github.com/jnuyens/modulejail/releases/download/v1.3.2/modulejail-1.3.2-1.noarch.rpm
sudo rpm -i modulejail-1.3.2-1.noarch.rpm
```
...
> ```
>
> From then on, `git tag -a v1.3.2 -m "..."` auto-signs without the
